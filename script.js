...
//   document.getElementById("product_color").innerHTML =
//     product_Data.product_color;
//   document.getElementById("product_quantity").innerHTML =
//     product_Data.product_quantity;
//   document.getElementById("product_manufacture_date").innerHTML =
//     product_Data.product_manufacture_date;
// };
...
//     "multiple_product_date",
//     JSON.stringify(multiple_product_data)
//   );
// };
document
  ...
  document.getElementById("displayAllData").onclick = function(){
    ...
    products.forEach(product => {
      ...
      colorCell.textContent = product.product_color;
      ...
      manufactureDateCell.textContent = product.product_manufacture_date;
